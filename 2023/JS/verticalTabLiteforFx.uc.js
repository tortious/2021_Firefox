...
// @description    CSS-Ersatz Lite-Version für Vertikale Tableiste
// @include        main
...
function verticalTabLiteforFx() {
  let verticalTabbar_maxWidth = 500;  /* Breite der Tab-Leiste in px */
  /* not yet */
  //let verticalTabPinned_width = 27; /* Breite der angehefteten Tabs in px */
  //let verticalScrollbar_width = 11; /* Breite der Bildlaufleiste in px */
...
/*      mask-image: linear-gradient(to left, transparent, black 0.05em) !important;*/
 ...
 /*bollow css code from https://egg.5ch.net/test/read.cgi/software/1579702570/676 */
  ...
  /* Positionsanpassung des angehefteten Tab-Symbols links/rechts */
  .tab-throbber[pinned],
  ...
  /* Schaltfläche „Schließen“ auf angehefteten Tab anzeigen. ・ linke, bzw. rechte Position anpassen */
  ...
  /* Pin-Markierungen zu angehefteten Tabs hinzufügen */
  ...
  /*  Pin-Markierung über dem Tab-Favicon einfügen */
