...
Bei "blackListArray" in Zeile 57 können Add-ons, die nicht im Menü angezeigt werden sollen,
		...
		var mMenus = [
			{
				...
				style: "min-width: 260px; margin-left: 13px;"
			},
			{
				...
				oncommand: "FileUtils.File(PathUtils.join(PathUtils.profileDir,['extensions'])).reveal();",
				style: "max-width: 20px;  padding-Left: 3px;"
			},
			{
				...
				style: "max-width: 20px;  padding-Left: 3px; margin-left: 10px; margin-right: 10px;"
			}
		];
